"""bead-chain (br / beads_rust variant): a beads-driven /goal variant.

Chains your `br ready` queue into the /goal loop one bead at a time. This
variant targets the beads_rust (`br`) CLI rather than the Go `bd` CLI
(default binary `br`; see spike bead_chain-5d3 for the adaptations).
"""
